...
class YaruColors {
  ...
  static const Color primary = Color(0xFF1D2134);


  static const Color contentBackgroundLight = Color(0xFFD3D7DC);

  static const Color selectBarHighlightColor = Color(0xFF24283F);
  static const Color selectBarNormalColor = Color(0xFF757883);
  /// Porcelain
  ...
  /// Light title bar
  static const Color titleBarLight = Color(0xFF262D4A);
  ...
  /// Kubuntu Blue
  static const Color kubuntuBlue = Color(0xFF0B91F0);
